...
import { CheckboxRightTextItem } from "@cx/components";

const variants = ["Circle", "Line"] as const;
const sizes = ["Medium", "Small"] as const;

const meta: Meta<typeof CheckboxRightTextItem> = {
  title: "cx/CheckboxRightTextItem",
  component: CheckboxRightTextItem as never,
  parameters: {
    controls: {
...
export default meta;
type Story = StoryObj<typeof CheckboxRightTextItem>;
