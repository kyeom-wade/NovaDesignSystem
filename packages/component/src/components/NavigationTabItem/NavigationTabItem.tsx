...
const ICONS = {
  Benefit: {
    ...
    unselected: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        <circle cx="12" cy="12" r="9" fill="rgba(6,12,31,0.4)" />
        <path d="M8 12l2.5 2.5L16 9" stroke="#fff" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    ),
  },
  Shopping: {
    selected: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        <path d="M6 7h12l-1.5 8H7.5L6 7Z" fill="#3617ce" />
        <path d="M9 7V6a3 3 0 1 1 6 0v1" stroke="#3617ce" strokeWidth="1.6" strokeLinecap="round" />
        <circle cx="9.5" cy="17.5" r="1" fill="#3617ce" />
        <circle cx="15.5" cy="17.5" r="1" fill="#3617ce" />
      </svg>
    ),
    unselected: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
  ...
  My: {
    selected: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        <circle cx="12" cy="8" r="3.5" fill="#3617ce" />
        <path d="M5 19c0-3.866 3.134-7 7-7s7 3.134 7 7" stroke="#3617ce" strokeWidth="1.8" strokeLinecap="round" />
      </svg>
    ),
    unselected: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
